...
class nyepam:
	...
	def mulai(self):
		...
		try:
			...
			exit("\033[1;36m[•] Spam Berhasil Terkirim ✓ \n\033[1;37m")
		except reek.exceptions.ReadTimeout:exit("[!] Sinyal Lu Jelek Stah...")
		except reek.exceptions.ConnectionError:exit("[!] Koneksi Eror")
		except (KeyboardInterrupt,EOFError):exit("\033[1;31m[!] Keluar ! \nThanks Udah Pakai Tolls ini \n Salam Dari Pembuat/Author\033[1;37m")
...
logo2 ="""
 ...
 \033[1;31m██╔╝ ██╗     ███████║██║     ██║  ██║██║ ╚═╝ ██║
 \033[1;32m╚═╝  ╚═╝     ╚══════╝╚═╝     ╚═╝  ╚═╝╚═╝     ╚═╝
         \033[1;37m[ Tolls Spam Sms && Call ]

        \033[1;47m \033[2;30m@Xenz-11 || Fb : Xenz Why  \033[0m
